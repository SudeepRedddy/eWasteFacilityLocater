        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex flex-col items-center text-center">
              <User className="h-16 w-16 text-[#4CAF50] mb-4 group-hover:scale-110 transition" />
          ...
          >
            <div className="flex flex-col items-center text-center">
              <Building2 className="h-16 w-16 text-[#4CAF50] mb-4 group-hover:scale-110 transition" />
